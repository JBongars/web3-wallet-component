...
$parcel$export(
  $faefaad95e5fcca0$exports,
  "WALLET_STATUS",
  () => $faefaad95e5fcca0$export$de76a1f31766a0a2
);
$parcel$export(
  $faefaad95e5fcca0$exports,
  "WALLET_HOOK",
  () => $faefaad95e5fcca0$export$5ee9bf08a91850b9
);
$parcel$export(
  $faefaad95e5fcca0$exports,
  "WALLETS",
  () => $faefaad95e5fcca0$export$412a02074a4127ac
);
...
(function (WALLET_STATUS1) {
  ...
  WALLET_STATUS1[(WALLET_STATUS1["EXTENSION_NOT_FOUND"] = 3)] =
    "EXTENSION_NOT_FOUND";
  WALLET_STATUS1[(WALLET_STATUS1["ACCOUNT_NOT_FOUND"] = 4)] =
    "ACCOUNT_NOT_FOUND";
})(
  $faefaad95e5fcca0$export$de76a1f31766a0a2 ||
    ($faefaad95e5fcca0$export$de76a1f31766a0a2 = {})
...
$parcel$export(
  $d083fd37dae77b99$exports,
  "NotImplementedError",
  () => $d083fd37dae77b99$export$e162153238934121
);
$parcel$export(
  $d083fd37dae77b99$exports,
  "WalletNotInstalledError",
  () => $d083fd37dae77b99$export$72563c16b91dfd16
);
$parcel$export(
  $d083fd37dae77b99$exports,
  "WalletNotConnectedError",
  () => $d083fd37dae77b99$export$313d299817c74896
);
$parcel$export(
  $d083fd37dae77b99$exports,
  "HookNotAvailableError",
  () => $d083fd37dae77b99$export$f4d277c155d1965e
);
...
$parcel$export(
  $2b09ea9ee8d63ad1$exports,
  "Metamask",
  () => $2b09ea9ee8d63ad1$export$2c78a3b4fc11d8fa
);
...
$parcel$export(
  $ff033dcd1750fc9d$exports,
  "useWindow",
  () => $ff033dcd1750fc9d$export$24b8fbafc4b6a151
);
...
class $4d8b59879bd0f2d0$var$HookRouter {
  ...
  checkIfValidHook(hook) {
    if (!this.hooks.has(hook))
      throw new (0, $d083fd37dae77b99$export$f4d277c155d1965e)();
  }
  getAvailableHooks() {
...
class $2b09ea9ee8d63ad1$export$2c78a3b4fc11d8fa {
  ...
  enforceIsConnected() {
    if (!this.getIsConnected())
      throw new (0, $d083fd37dae77b99$export$313d299817c74896)();
  }
  async init() {
  ...
  getIsWalletInstalled() {
    const ethereum = (0, $ff033dcd1750fc9d$export$24b8fbafc4b6a151)(
      async (windowObject) => windowObject.ethereum
    );
  ...
  async getProvider() {
    const ethereum = await (0, $ff033dcd1750fc9d$export$24b8fbafc4b6a151)(
      async (windowObject) => windowObject.ethereum
    );
    if (ethereum === null)
      throw new (0, $d083fd37dae77b99$export$72563c16b91dfd16)();
...
class $d5d3dec9ab4b7763$var$Ethereum {
  constructor(data) {
    this.metaMask = new (0, $2b09ea9ee8d63ad1$export$2c78a3b4fc11d8fa)(
      data?.metaMask
    );
  }
}
...
$parcel$export(
  $a75d728b25ccd0d3$exports,
  "MyAlgo",
  () => $a75d728b25ccd0d3$export$6ab354d5c56bf95
);
...
class $a75d728b25ccd0d3$export$6ab354d5c56bf95 {
  ...
  getProvider() {
    if (
      ...
      (0, $parcel$interopDefault($8zHUo$randlabsmyalgoconnect))
    )
      return this.provider;
    this.provider = new (0,
    $parcel$interopDefault($8zHUo$randlabsmyalgoconnect))();
    return this.provider;
  }
}
...
$parcel$export(
  $f2b728861576b445$exports,
  "Algorand",
  () => $f2b728861576b445$export$2a2454b5976b73ac
);

class $f2b728861576b445$export$2a2454b5976b73ac {
  constructor(data) {
    this.myAlgo = new (0, $a75d728b25ccd0d3$export$6ab354d5c56bf95)(
      data?.myAlgo
    );
  }
}

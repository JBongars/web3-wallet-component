...
class $95e4ef1726fa05c6$export$6a733d504587e4b0 {
    ...
    async signIn() {
        ...
        this.registerDisconnectListener();
        const algorandAcc = accounts.filter((value)=>(0, $hgUW1$isValidAddress)(value));
    ...
    getProvider() {
        if (this.provider && this.provider instanceof (0, $hgUW1$PeraWalletConnect)) return this.provider;
        const provider = new (0, $hgUW1$PeraWalletConnect)();
...
class $07e52f3c9fc905f8$export$9741c3aebc6a0fb7 {
    ...
    async _getProvider() {
        ...
        this.provider = new (0, $hgUW1$providers).Web3Provider(provider, "any");
        return this.provider;
    }
    _enforceIsConnected() {
        if (!this.getIsConnected()) throw new (0, $28ac839a9eca26f5$export$313d299817c74896)();
    ...
    async getWCProvider() {
        ...
        this._walletConnectProvider = new (0, $hgUW1$walletconnectweb3provider)({
            rpc: rpc,
            qrcode: true,
            qrcodeModalOptions: {
                desktopLinks: []
